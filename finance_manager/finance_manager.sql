...
(1, 1, 1, 1000.00, '2024-10-13', '2024-10-19');
...
INSERT INTO `transactions` (`id`, `user_id`, `amount`, `type`, `category_id`, `date`, `description`) VALUES
(1, 1, 1000.00, 'income', 1, '2024-10-13', 'Savings'),
(2, 1, 9700.00, 'income', 1, '2024-10-13', 'savings');
...
(1, 'victory', '$2y$10$YEWdsE/NQpU4q1Y6sNUET.0GNsuO.zkZcrqWeD/Hl936WGplrOtI.', 'victory@gmail.com', '2024-10-13 18:56:55');
